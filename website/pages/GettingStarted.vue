  ...
  <q-page padding>
    <div class="row q-py-lg">
      <q-card square flat class="col q-px-xs q-pt-xl">
        <span
          class="bg-grey-6 text-white text-body2 q-py-sm q-px-md border-radius-sm"
          >{{ tag }}</span
        >
        <div class="text-h2 text-grey-9 text-weight-bold q-mt-sm q-mb-xl">
          {{ details }}
        </div>
      ...
      <q-card square flat class="col-7 gt-sm">
        <q-img
          height="55vh"
          :src="WebsiteAsset"
          alt="Website image"
