  ...
  <q-header reveal :elevated="false" class="bg-transparent">
    <q-toolbar>
      ...
      <div class="q-gutter-xs">
        <q-btn flat square color="primary" icon="bi-search" class="border-radius-sm" />
        <q-btn flat square color="primary" icon="bi-bell" class="border-radius-sm" />
        <q-btn square color="primary" icon="bi-plus-lg" class="border-radius-sm" />
      </div>
    </q-toolbar>
  </q-header>
</template>
