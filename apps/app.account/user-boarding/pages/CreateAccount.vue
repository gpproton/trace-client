...
<template>
  <div class="row justify-center">
    <q-card square flat class="q-mt-xl q-pa-md onboard-form">
      <div class="q-mb-md">
        <div class="text-h4">{{ 'Complete invitation' }}</div>
        <div class="text-grey">{{ 'message' }}</div>
      </div>
      <q-form class="q-gutter-y-md">
        <div class="row q-gutter-x-sm">
          <q-input v-model="name" filled label="Firstname" />
          <q-input v-model="name" filled label="Lastname" />
        </div>
        <q-input v-model="name" filled label="Phone" />
        <q-input v-model="name" filled label="Extra" />
